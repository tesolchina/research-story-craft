...
│   └── self-assessment.md # Your reflection
├── instructions.md       # Activity instructions
└── output/
    └── action-plan.md    # Generated by AI`}
              </pre>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="ml-6 p-4 bg-muted/50 rounded-lg text-sm space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                <li>Task: Analyze the input files and develop an action plan</li>
                <li>Consider the issues listed above</li>
                <li>Output format requirements for the action plan</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="ml-6 p-4 bg-muted/50 rounded-lg text-sm space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                ...
                <li>Let it analyze all input files</li>
                <li>Review and refine the generated action plan</li>
              </ul>
            </div>
          </div>
